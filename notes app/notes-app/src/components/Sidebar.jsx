...
const Sidebar = ({ currentView, onViewChange, onCreateNote, onLogin, onSignup, theme, toggleTheme, onShowMindMap }) => {
  const menuItems = [
    {
      id: "all",
      label: "All Notes",
    ...
    <aside className="w-16 md:w-72 bg-sidebar border-r border-border flex flex-col shadow-lg font-body transition-all duration-300">
      ...
      <div className="p-2 md:p-6 border-t border-border space-y-3 bg-muted">
        ...
        >
          ...
          <span className="font-medium text-refined hidden md:inline">Mind Map</span>
        </button>
